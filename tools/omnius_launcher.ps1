...
# The telegram bridge is NOT here on purpose: the watchdog starts it (and
# restarts it) whenever config\telegram.ini names somebody, so starting the
# watchdog above is already enough. See ensure_telegram_bridge.
